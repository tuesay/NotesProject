...
class Ui_Notes(object):
    def setupUi(self, Notes):
        ...
        self.noteCount = QtWidgets.QLabel(parent=self.centralwidget)
        self.noteCount.setEnabled(False)
        self.noteCount.setText("")
        self.noteCount.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.LinksAccessibleByMouse)
        self.noteCount.setObjectName("noteCount")
        self.gridLayout.addWidget(self.noteCount, 1, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.noteList, 2, 0, 2, 5)
